...
Assistant tool calls and tool results are condensed to bounded transcript
summaries matching the pinned TypeScript formatter; bash/summary entry variants
remain open.
