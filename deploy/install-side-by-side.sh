...
exec env -i PATH=/usr/bin:/bin HOME=/root \\
	  ...
	  YEN_AZURE_OPENAI_RESOURCE_NAME="\${YEN_AZURE_OPENAI_RESOURCE_NAME:-}" \\
	  YEN_AZURE_OPENAI_API_VERSION="\${YEN_AZURE_OPENAI_API_VERSION:-v1}" \\
	  YEN_AZURE_OPENAI_API_KEY="\${YEN_AZURE_OPENAI_API_KEY:-}" \\
	  YEN_AGENT_DIR="\${YEN_AGENT_DIR:-}" \\
	  YEN_GOOGLE_API_KEY="\${YEN_GOOGLE_API_KEY:-}" \\
	  YEN_GOOGLE_BASE_URL="\${YEN_GOOGLE_BASE_URL:-}" \\
	  YEN_GOOGLE_CLOUD_API_KEY="\${YEN_GOOGLE_CLOUD_API_KEY:-}" \\
	  YEN_GOOGLE_CLOUD_PROJECT="\${YEN_GOOGLE_CLOUD_PROJECT:-}" \\
	  YEN_GOOGLE_CLOUD_LOCATION="\${YEN_GOOGLE_CLOUD_LOCATION:-}" \\
	  YEN_GOOGLE_VERTEX_BASE_URL="\${YEN_GOOGLE_VERTEX_BASE_URL:-}" \\
	  YEN_GOOGLE_VERTEX_ACCESS_TOKEN="\${YEN_GOOGLE_VERTEX_ACCESS_TOKEN:-}" \\
	  YEN_COPILOT_GITHUB_TOKEN="\${YEN_COPILOT_GITHUB_TOKEN:-}" \\
	  YEN_COPILOT_BASE_URL="\${YEN_COPILOT_BASE_URL:-}" \\
	  YEN_OPENAI_CODEX_ACCESS_TOKEN="\${YEN_OPENAI_CODEX_ACCESS_TOKEN:-}" \\
	  YEN_OPENAI_CODEX_BASE_URL="\${YEN_OPENAI_CODEX_BASE_URL:-}" \\
