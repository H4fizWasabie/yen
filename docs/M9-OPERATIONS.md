...
The pilot has passed live health, systemd restart, OpenRouter smoke, and
dashboard routing. Fresh backup and rollback evidence remain required before
M10 cutover discussion.
