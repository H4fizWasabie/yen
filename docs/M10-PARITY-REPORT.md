...
| Telegram | `packages/telegram/src/index.ts:31-33`, `:290-296`, `:340-385`, `:630-700` | dedicated unit, Unicode chunking and reply-context/target tests, cancellable typing-action loop, valid token, live reply, owner guard, `/stop` unit test | partial; rich rendering, images, and live long-reply/reply acceptance deferred |
