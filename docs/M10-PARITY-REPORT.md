...
| Resources and trust | `3b6aa0e`, `d7bc219`, `ca967c4`, bounded context, lazy skills, settings, trust store; steering/follow-up queue modes and auto-compaction now load from settings at startup; disabled skills remain explicit-only | extension hooks and full settings parity |
...
The current verified code gate is 298 tests, race tests, vet, and diff checks.
