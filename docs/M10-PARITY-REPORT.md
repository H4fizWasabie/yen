...
| Provider | `packages/ai/src/api/openai-completions.ts:699-717`, `:830-930`, `:523-551`, `:1553-1575`, `packages/ai/src/utils/overflow.ts:39-171` | deterministic SSE including explicit-null finish reasons, response-body overflow classification, transient exclusion, reasoning-effort request shape, response ID/model and raw finish-reason preservation, finish-reason error mapping, and live `z-ai/glm-5.3-flash` OpenRouter reply using Yen-owned credentials | partial; provider matrix open |
